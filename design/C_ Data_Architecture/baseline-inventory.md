...
| INV-03 | Hypothesis | All KCs have one or more KCRV | Reference values (KCRV/CRV) and variants | APMP.AUV.A-K5; AFRIMETS.AUV.V-K5; APMP.EM-K12; CCM.F-K23 |
| INV-04 | Hypothesis | All KCs have one or more DOE | Degrees of Equivalence and coverage metrics | APMP.AUV.A-K5; AFRIMETS.AUV.V-K5; APMP.EM-K12; CCM.F-K23 |
...
| INV-09 | Observation | Some KC/SC are reporting the mutual/unilateral DOEs | Degrees of Equivalence and coverage metrics | CCT-K8; CCT-K3; CCPR-K1.a |
...
| INV-15 | Observation | Some measurands are complex (CCEM) | Measurand complexity | |
| INV-16 | Observation | Some measurands are complex vectors (CCEM) | Measurand complexity | CCEM.RF-K5.c.CL |
| INV-17 | Hypothesis | Some measurement conditions in the KC/SC are the same as in the related CMC | KC/SC ↔ CMC relationships | |
| INV-18 | Observation | Some KC/SC calculate specific-artefact-based CRVs only | Reference values (KCRV/CRV) and variants | EURAMET.EM-S36; CCM.FF-K2.2011; APMP.AUV.V-S1; CCEM.RF-K26 |
...
- **Degrees of Equivalence and coverage metrics:** INV-04, 06, 08, 09, 19, 23, 25, 28, 29, 30  
